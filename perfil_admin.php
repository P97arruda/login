...
<body class="p-3 m-0 border-0 bd-example m-0 border-0">
    ...
    <h1 id="perfil-h1">Perfil do Administrador</h1>

    <p style="text-align:center;"><img src="imagens/admin.jpg" alt="persona" width="20%" height="auto" style="border-radius:50%;"></p>
